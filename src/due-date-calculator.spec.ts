...
describe('Due Date Calculator', () => {
  ...
  it('should throw an error for invalid report date', () => {
    ...
    expect(() => calculateDueDate({ reportDate, turnAroundTime })).toThrowError(errorMessage);
  })
  ...
  describe('turnaround time', () => {
    ...
    it('shoud throw an error when a negative value is given', () => {
      expect(() => {
        const turnAroundTime = -16;
    ...
    it('shoud throw an error when value equals zero', () => {
      expect(() => {
    ...
    it('shoud not throw an error when a valid value is given', () => {
      expect(() => {
        const turnAroundTime = 1;
